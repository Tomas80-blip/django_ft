# URL maršrutai, vaizdai (views) ir šablonai (templates)
...
#  Kai vartotojas atidaro tam tikrą adresą naršyklėje, Django sistema tikrina,
# ar tas adresas yra aprašytas projekto urls.py faile. Jei randa atitinkamą maršrutą,
# iškviečia nurodytą Python funkciją (vadinamą view), kuri sugeneruoja atsakymą.
#
# Maršruto aprašymas:
#
...
# Projekto urls.py faile dažniausiai yra pagrindinis maršrutų žemėlapis,
# kuris įtraukia visų aplikacijų urls.py failus per include():
#
...
# View funkcijos apdoroja naršyklės užklausas ir grąžina atsakymą.
# Paprasčiausiu atveju jos gali grąžinti tekstą:
#
...
# Šablonai (templates/)
# Django šablonai – tai HTML failai, kuriuose galima naudoti specialią Django sintaksę – šablonų žymėjimus.
#Jie leidžia dinamiškai keisti turinį priklausomai nuo duomenų, gautų iš view funkcijos.
#
...
# Šablonų failai turi būti laikomi kataloge templates,
# kurį reikia sukurti aplikacijos viduje. Django automatiškai ieško HTML failų šioje vietoje,
# jei ji nurodyta settings.py faile.
#
# render() funkcija ir context
# Funkcija render() leidžia atvaizduoti HTML failą, bet ir perduoti kintamuosius (kontekstą),
# kuriuos galima naudoti šablone:
#
# from django.shortcuts import render
# def pagrindinis(request):
#     kontekstas = {
