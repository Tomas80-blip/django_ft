...
# on_delete reikšmės
# Naudojant ForeignKey ar OneToOneField, būtina nurodyti on_delete elgseną:
#
# CASCADE – susijusiam objektui ištrynus, ištrinami ir priklausomi objektai
# SET_NULL – nustatoma reikšmė null (reikia null=True)
# PROTECT – neleidžia ištrinti susijusio objekto
# SET_DEFAULT – nustato numatytąją reikšmę
